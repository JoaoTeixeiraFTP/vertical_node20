import TaskImage from '../../../../../../Documents/mosaicreact/mosaic-react/src/images/task-image-02.jpg';
import UserImage01 from '../../../../../../Documents/mosaicreact/mosaic-react/src/images/user-28-12.jpg';
        ...
        <div className="rounded-xl bg-white p-4 shadow-sm dark:bg-gray-800">
            ...
            <div className="mb-3">
                ...
                <div className="mb-2 flex items-center">
                    ...
                    <div className="grow">
                        <a className="inline-flex text-gray-800 hover:text-gray-900 dark:text-gray-100 dark:hover:text-white" href="#0">
                ...
                <div>
                    ...
                    <img className="mt-3 w-full" src={TaskImage} width="259" height="142" alt="Task 02" />
                </div>
            </div>
            {/* Footer */}
