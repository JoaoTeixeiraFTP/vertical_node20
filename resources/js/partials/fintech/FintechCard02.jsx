...
import EditMenu from '../../../../../../Documents/mosaicreact/mosaic-react/src/components/DropdownEditMenuCard.jsx';

function FintechCard02() {
    return (
        <div className="col-span-full flex flex-col rounded-xl bg-[linear-gradient(225deg,var(--tw-gradient-stops))] from-gray-800 to-gray-900 shadow-sm xl:col-span-4">
            ...
            <div className="flex h-full flex-col px-5 py-6">
                ...
                <div className="relative mx-auto w-full max-w-sm rounded-2xl bg-gray-700/50 p-2.5">
                    {/* Credit Card */}
                    <div className="relative aspect-[7/4] overflow-hidden rounded-xl bg-gradient-to-tr from-gray-900 to-gray-800 p-5">
                    ...
                    {/* Options button */}
                    <EditMenu align="right" className="absolute right-0 top-0 inline-flex">
                        <li>
                            <Link
                ...
                <div className="mt-3 flex grow flex-col justify-center">
                    <div className="mb-3 text-xs font-semibold uppercase text-gray-500">Details</div>
                    <div className="space-y-2">
                        <div>
                            ...
                            <div className="relative h-2 w-full rounded bg-gray-600">
                                <div className="absolute inset-0 rounded-full bg-green-400" aria-hidden="true" style={{ width: '50%' }} />
                            </div>
                        </div>
                        <div>
                            <div className="mb-2 flex justify-between text-sm">
                            ...
                            <div className="relative h-2 w-full rounded bg-gray-600">
                                <div className="absolute inset-0 rounded-full bg-green-400" aria-hidden="true" style={{ width: '35%' }} />
                            </div>
                        </div>
                    </div>
                </div>
