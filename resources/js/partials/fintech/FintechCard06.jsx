import UserImage from '../../../../../../Documents/mosaicreact/mosaic-react/src/images/user-36-05.jpg';
        ...
        <div className="col-span-full rounded-xl bg-white shadow-sm dark:bg-gray-800 xl:col-span-6">
            ...
            <div className="p-3">
                ...
                <div className="border-t border-gray-100 px-2 text-center dark:border-gray-700/60">
                    <a
                        className="block pb-1 pt-4 text-sm font-medium text-violet-500 hover:text-violet-600 dark:hover:text-violet-400"
                        href="#0"
                    >
                        View All -&gt;
                    </a>
