import LineChart from '../../../../../../Documents/mosaicreact/mosaic-react/src/charts/LineChart09.jsx';
...
function FintechCard14() {
    const miniCharts = [
        ...
        // Coinbase
        {
            data: [632, 510, 610, 404, 504, 404, 449, 349, 404, 542, 404, 410, 491, 392, 254, 273, 291, 191, 226, 363, 449, 252, 223, 222, 170, 132],
            growth: false,
        },
    ];
                            ...
                            <tr>
                                <td className="whitespace-nowrap p-2 md:w-1/2">
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            <div className="uppercase text-gray-800 dark:text-gray-100">Gvolt</div>
                            ...
                            <tr>
                                <td className="whitespace-nowrap p-2 md:w-1/2">
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            <div className="uppercase text-gray-800 dark:text-gray-100">Fb</div>
                            ...
                            <tr>
                                <td className="whitespace-nowrap p-2 md:w-1/2">
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            <div className="uppercase text-gray-800 dark:text-gray-100">Googl</div>
                            ...
                            <tr>
                                <td className="whitespace-nowrap p-2 md:w-1/2">
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            <div className="uppercase text-gray-800 dark:text-gray-100">Aapl</div>
                            ...
                            <tr>
                                <td className="whitespace-nowrap p-2 md:w-1/2">
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            <div className="uppercase text-gray-800 dark:text-gray-100">Coin</div>
