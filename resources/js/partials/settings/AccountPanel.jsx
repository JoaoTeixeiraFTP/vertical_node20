...
import Image from '../../../../../../Documents/mosaicreact/mosaic-react/src/images/user-avatar-80.png';
            ...
            <div className="space-y-6 p-6">
                ...
                <section>
                    <div className="flex items-center">
                        <div className="mr-4">
                            <img className="h-20 w-20 rounded-full" src={Image} width="80" height="80" alt="User upload" />
                        </div>
                ...
                {/* Business Profile */}
                <section>
                    <h2 className="mb-1 text-xl font-bold leading-snug text-gray-800 dark:text-gray-100">Business Profile</h2>
                ...
                {/* Email */}
                <section>
                    <h2 className="mb-1 text-xl font-bold leading-snug text-gray-800 dark:text-gray-100">Email</h2>
                ...
                {/* Password */}
                <section>
                    <h2 className="mb-1 text-xl font-bold leading-snug text-gray-800 dark:text-gray-100">Password</h2>
                    <div className="text-sm">You can set a permanent password if you don't want to use temporary login codes.</div>
                    <div className="mt-5">
                        <button className="btn border-gray-200 text-violet-500 shadow-sm dark:border-gray-700/60">Set New Password</button>
                    </div>
                </section>
                {/* Smart Sync */}
                <section>
                    <h2 className="mb-1 text-xl font-bold leading-snug text-gray-800 dark:text-gray-100">Smart Sync update for Mac</h2>
                    ...
                    <div className="mt-5 flex items-center">
                        ...
                        <div className="ml-2 text-sm italic text-gray-400 dark:text-gray-500">{sync ? 'On' : 'Off'}</div>
                    </div>
                </section>
            </div>
            {/* Panel footer */}
