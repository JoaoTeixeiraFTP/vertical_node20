            ...
            <div className="p-6">
                ...
                <section className="border-b border-gray-200 pb-6 dark:border-gray-700/60">
                    <div className="grid grid-cols-12 gap-6">
                        {/* Card 1 */}
                        <div className="col-span-full rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-700/60 dark:bg-gray-800 xl:col-span-6 2xl:col-span-4">
                            {/* Card content */}
                ...
                <section>
                    <h3 className="mb-5 mt-6 text-xl font-bold leading-snug text-gray-800 dark:text-gray-100">Trending Categories</h3>
                    <div className="grid grid-cols-12 gap-6">
                        {/* Card 1 */}
                        <div className="col-span-full rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-700/60 dark:bg-gray-800 xl:col-span-4">
                            {/* Card content */}
                            <div className="flex h-full flex-col p-5">
                                <div className="grow">
                                    <header>
                                ...
                                <footer className="mt-2">
                                    <div className="flex flex-wrap items-center justify-between">
                                        {/* Left side */}
                                        <div className="text-sm italic text-gray-500 dark:text-gray-400">400+ Apps</div>
                                        {/* Right side */}
                        ...
                        <div className="col-span-full rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-700/60 dark:bg-gray-800 xl:col-span-4">
                            ...
                            <div className="flex h-full flex-col p-5">
                                ...
                                <footer className="mt-2">
                                    <div className="flex flex-wrap items-center justify-between">
                                        {/* Left side */}
                                        <div className="text-sm italic text-gray-500 dark:text-gray-400">320+ Apps</div>
                                        {/* Right side */}
                                        <a className="text-sm font-medium text-violet-500 hover:text-violet-600 dark:hover:text-violet-400" href="#0">
                                            Explore -&gt;
                                        </a>
                        ...
                        <div className="col-span-full rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-700/60 dark:bg-gray-800 xl:col-span-4">
                            ...
                            <div className="flex h-full flex-col p-5">
                                ...
                                <footer className="mt-2">
                                    <div className="flex flex-wrap items-center justify-between">
                                        {/* Left side */}
                                        <div className="text-sm italic text-gray-500 dark:text-gray-400">270+ Apps</div>
                                        {/* Right side */}
                                        <a className="text-sm font-medium text-violet-500 hover:text-violet-600 dark:hover:text-violet-400" href="#0">
                                            Explore -&gt;
                                        </a>
