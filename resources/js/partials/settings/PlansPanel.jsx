    ...
    return (
        <div className="grow">
            ...
            <div className="space-y-6 p-6">
                ...
                <section>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-12 gap-6">
                            {/* Tab 1 */}
                            <div className="relative col-span-full rounded-b-lg border border-gray-200 bg-white shadow-sm dark:border-gray-700/60 dark:bg-gray-800 xl:col-span-4">
                                <div className="absolute left-0 right-0 top-0 h-0.5 bg-green-500" aria-hidden="true"></div>
                            ...
                            {/* Tab 2 */}
                            <div className="relative col-span-full rounded-b-lg border border-gray-200 bg-white shadow-sm dark:border-gray-700/60 dark:bg-gray-800 xl:col-span-4">
                                <div className="absolute left-0 right-0 top-0 h-0.5 bg-sky-500" aria-hidden="true"></div>
                                <div className="border-b border-gray-200 px-5 pb-6 pt-5 dark:border-gray-700/60">
                                    <header className="mb-2 flex items-center">
                            ...
                            {/* Tab 3 */}
                            <div className="relative col-span-full rounded-b-lg border border-gray-200 bg-white shadow-sm dark:border-gray-700/60 dark:bg-gray-800 xl:col-span-4">
                                <div className="absolute left-0 right-0 top-0 h-0.5 bg-violet-500" aria-hidden="true"></div>
                                <div className="border-b border-gray-200 px-5 pb-6 pt-5 dark:border-gray-700/60">
                                    <header className="mb-2 flex items-center">
                ...
                {/* Contact Sales */}
                <section>
                    <div className="rounded-lg bg-[linear-gradient(135deg,var(--tw-gradient-stops))] from-violet-500/[0.12] to-violet-500/[0.04] px-5 py-3 text-center dark:from-violet-500/[0.24] xl:flex xl:flex-wrap xl:items-center xl:justify-between xl:text-left">
                        <div className="mb-2 font-semibold text-gray-800 dark:text-gray-100 xl:mb-0">Looking for different configurations?</div>
                ...
                <section>
                    ...
                    <ul className="space-y-5">
                        ...
                        <li>
                            ...
                            <div className="text-sm">
                                Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum in
