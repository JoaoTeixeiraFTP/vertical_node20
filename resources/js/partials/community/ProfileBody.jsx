...
import Icon02 from '../../../../../../Documents/mosaicreact/mosaic-react/src/images/icon-02.svg';
import Icon03 from '../../../../../../Documents/mosaicreact/mosaic-react/src/images/icon-03.svg';
import ProfileBg from '../../../../../../Documents/mosaicreact/mosaic-react/src/images/profile-bg.jpg';
import UserAvatar from '../../../../../../Documents/mosaicreact/mosaic-react/src/images/user-128-01.jpg';
    ...
    return (
        ...
        >
            ...
            <div className="relative h-56 bg-gray-200 dark:bg-gray-900">
                <img className="h-full w-full object-cover" src={ProfileBg} width="979" height="220" alt="Profile background" />
                {/* Close button */}
                <button
                ...
                <header className="mb-6 text-center sm:text-left">
                    ...
                    <div className="flex flex-wrap justify-center space-x-4 sm:justify-start">
                        <div className="flex items-center">
                            ...
                            <span className="ml-2 whitespace-nowrap text-sm font-medium text-gray-500 dark:text-gray-400">Milan, IT</span>
                        </div>
                        <div className="flex items-center">
                            <svg className="shrink-0 fill-current text-gray-400 dark:text-gray-500" width="16" height="16" viewBox="0 0 16 16">
                            ...
                            <a
                                className="ml-2 whitespace-nowrap text-sm font-medium text-violet-500 hover:text-violet-600 dark:hover:text-violet-400"
                                href="#0"
                            >
                                carolinmcneail.com
                            </a>
                                    ...
                                    <li className="sm:flex sm:items-center sm:justify-between">
                                        ...
                                        <div className="mt-2 sm:ml-2 sm:mt-0">
                                            <ul className="-m-1 flex flex-wrap sm:justify-end">
                                                <li className="m-1">
                                                    <button className="inline-flex items-center justify-center rounded-full border border-gray-200 bg-white px-2.5 py-0.5 text-xs font-medium leading-5 text-gray-500 shadow-sm transition hover:border-gray-300 dark:border-gray-700/60 dark:bg-gray-800 dark:text-gray-400 dark:hover:border-gray-600">
                                                        Marketing
                                                    </button>
                                                </li>
                                                <li className="m-1">
