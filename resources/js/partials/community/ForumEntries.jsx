...
import SponsorImg from '../../../../../../Documents/mosaicreact/mosaic-react/src/images/company-icon-06.svg';
...
import UserImage07 from '../../../../../../Documents/mosaicreact/mosaic-react/src/images/user-32-07.jpg';
import UserAvatar from '../../../../../../Documents/mosaicreact/mosaic-react/src/images/user-avatar-32.png';
        ...
        <>
                ...
                <div className="flex-start flex space-x-4">
                    ...
                    <div className="shrink-0">
                        <button className="flex h-12 w-12 flex-col items-center justify-center rounded-lg border border-violet-500/60 text-center text-xs font-semibold shadow-violet-500/20">
                            <svg className="mb-1.5 mt-1.5 inline-flex fill-violet-500" width="12" height="6" xmlns="http://www.w3.org/2000/svg">
            ...
            <article className="rounded-xl bg-white p-5 shadow-sm dark:bg-gray-800">
                <div className="flex-start flex space-x-4">
                    {/* Avatar */}
                    <div className="mt-1.5 shrink-0">
                        <img className="h-8 w-8 rounded-full" src={SponsorImg} width="32" height="32" alt="Crypto" />
                    </div>
                    {/* Content */}
                    <div className="grow">
                        {/* Title */}
                        ...
                        <footer className="flex flex-wrap text-sm">
                            ...
                            <div className="flex items-center after:block after:px-2 after:text-sm after:text-gray-400 after:content-['·'] last:after:content-[''] dark:after:text-gray-600">
                                <span className="italic text-gray-500">Promoted</span>
                            </div>
                        </footer>
                    </div>
                </div>
            ...
            <article className="rounded-xl bg-white p-5 shadow-sm dark:bg-gray-800">
                <div className="flex-start flex space-x-4">
                    {/* Avatar */}
                    <div className="mt-1.5 shrink-0">
                        <img className="h-8 w-8 rounded-full" src={UserImage07} width="32" height="32" alt="User 07" />
                    </div>
                    {/* Content */}
                    <div className="grow">
                        {/* Title */}
