...
import EditMenu from '../../../../../../Documents/mosaicreact/mosaic-react/src/components/DropdownEditMenu.jsx';

import FeedImage01 from '../../../../../../Documents/mosaicreact/mosaic-react/src/images/feed-image-01.jpg';
import FeedImage02 from '../../../../../../Documents/mosaicreact/mosaic-react/src/images/feed-image-02.jpg';
import CommenterImage04 from '../../../../../../Documents/mosaicreact/mosaic-react/src/images/user-32-04.jpg';
import CommenterImage05 from '../../../../../../Documents/mosaicreact/mosaic-react/src/images/user-32-05.jpg';
import UserImage02 from '../../../../../../Documents/mosaicreact/mosaic-react/src/images/user-40-02.jpg';
import UserImage03 from '../../../../../../Documents/mosaicreact/mosaic-react/src/images/user-40-03.jpg';
import UserImage04 from '../../../../../../Documents/mosaicreact/mosaic-react/src/images/user-40-04.jpg';
import UserImage06 from '../../../../../../Documents/mosaicreact/mosaic-react/src/images/user-40-06.jpg';
import UserImage08 from '../../../../../../Documents/mosaicreact/mosaic-react/src/images/user-40-08.jpg';
        ...
        <>
            ...
            <div className="rounded-xl bg-white p-5 shadow-sm dark:bg-gray-800">
                ...
                <header className="mb-3 flex items-start justify-between space-x-3">
                    ...
                    <div className="flex items-start space-x-3">
                        <img className="shrink-0 rounded-full" src={UserImage03} width="40" height="40" alt="User 03" />
                        <div>
                ...
                <div className="mb-5 space-y-2 text-sm text-gray-800 dark:text-gray-100">
                    <p>👋</p>
                    <p>
                        It's more likely that people reading your blog will opt in with their email addresses if you give them something highly
                        relevant in return. Ditch that too-general lead magnet and create "content upgrades" for your highest-traffic articles.
                    </p>
                    <p>Thread 👇</p>
                </div>
                {/* Footer */}
            ...
            <div className="rounded-xl bg-white p-5 shadow-sm dark:bg-gray-800">
                ...
                <header className="mb-3 flex items-start justify-between space-x-3">
                    {/* User */}
                    <div className="flex items-start space-x-3">
                        <img className="shrink-0 rounded-full" src={UserImage06} width="40" height="40" alt="User 06" />
                        <div>
                            <div className="leading-tight">
                                <a className="text-sm font-semibold text-gray-800 dark:text-gray-100" href="#0">
                                    Mark Karimani
                ...
                <div className="mb-5 space-y-2 text-sm text-gray-800 dark:text-gray-100">
                    ...
                    <div className="relative !my-4">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 bg-black bg-opacity-25 p-4 backdrop-blur-md">
            ...
            <div className="rounded-xl bg-white p-5 shadow-sm dark:bg-gray-800">
                ...
                <header className="mb-3 flex items-start justify-between space-x-3">
                    {/* User */}
                    <div className="flex items-start space-x-3">
                        <img className="shrink-0 rounded-full" src={UserImage04} width="40" height="40" alt="User 04" />
                        <div>
                            <div className="leading-tight">
                                <a className="text-sm font-semibold text-gray-800 dark:text-gray-100" href="#0">
                                    Erica Spriggs
                ...
                <div className="mt-5 border-t border-gray-100 pt-3 dark:border-gray-700/60">
                    <ul className="mb-3 space-y-2">
                        {/* Comment */}
                        <li className="rounded bg-gray-50 p-3 dark:bg-gray-700/30">
                            <div className="flex items-start space-x-3">
                                <img className="shrink-0 rounded-full" src={CommenterImage04} width="32" height="32" alt="User 04" />
                                <div>
                        ...
                        <li className="rounded bg-gray-50 p-3 dark:bg-gray-700/30">
                            <div className="flex items-start space-x-3">
                                <img className="shrink-0 rounded-full" src={CommenterImage05} width="32" height="32" alt="User 05" />
                                <div>
                                    <div className="text-xs text-gray-500">
                                        <a className="font-semibold text-gray-800 dark:text-gray-100" href="#0">
                                            Kyla Scanlon
                                    ...
                                    <div className="text-sm">
                                        Depends on the company you're running, but if I had to choose just one book, it'd be The Personal MBA by Josh
                                        Kaufman.
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="mt-3 flex items-center space-x-3">
                        <img className="shrink-0 rounded-full" src={UserImage02} width="32" height="32" alt="User 02" />
                        <div className="grow">
            ...
            <div className="rounded-xl bg-white p-5 shadow-sm dark:bg-gray-800">
                ...
                <header className="mb-3 flex items-start justify-between space-x-3">
                    {/* User */}
                    <div className="flex items-start space-x-3">
                        <img className="shrink-0 rounded-full" src={UserImage08} width="40" height="40" alt="User 08" />
                        <div>
                            <div className="leading-tight">
                                <a className="text-sm font-semibold text-gray-800 dark:text-gray-100" href="#0">
                                    Margaret Sullivan
                    ...
                    <div className="relative !my-4 flex items-center justify-center">
                        ...
                        <div className="absolute bottom-4 left-4 right-4">
                            <div className="flex items-center space-x-1">
                                <div className="bg-black bg-opacity-25 px-2 py-1 text-xs font-medium text-gray-300">0:48</div>
                                <div className="bg-black bg-opacity-25 px-2 py-1 text-xs font-medium text-gray-300">1M Views</div>
                            </div>
                        </div>
                    </div>
                </div>
