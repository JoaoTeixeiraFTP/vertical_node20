function ForumLeftContent() {
    return (
        <div className="mb-8 w-full md:mb-0 md:w-60">
                ...
                <div className="md:py-8">
                    <div className="flex items-center justify-between md:block">
                        ...
                        <header className="mb-6">
                            <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-100 md:text-3xl">Forum</h1>
                        </header>

                        {/* Button */}
                        <div className="mb-6 xl:hidden">
                            <button className="btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white md:w-full">
                                Create Post
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="no-scrollbar -mx-4 flex flex-nowrap overflow-x-scroll px-4 md:block md:space-y-3 md:overflow-auto">
                        {/* Group 1 */}
                        <div>
                            <div className="mb-3 text-xs font-semibold uppercase text-gray-400 dark:text-gray-500 md:sr-only">Menu</div>
                            <ul className="mr-3 flex flex-nowrap md:mr-0 md:block">
                                <li className="mr-0.5 md:mb-0.5 md:mr-0">
                                    <a className="flex items-center whitespace-nowrap rounded-lg bg-white px-2.5 py-2 dark:bg-gray-800" href="#0">
                                        <svg className="mr-2 shrink-0 fill-current text-violet-500" width="16" height="16" viewBox="0 0 16 16">
                                ...
                                <li className="mr-0.5 md:mb-0.5 md:mr-0">
                                    <a className="flex items-center whitespace-nowrap rounded-lg px-2.5 py-2" href="#0">
                                        <svg
                        ...
                        {/* Group 2 */}
                        <div>
                            <div className="mb-3 text-xs font-semibold uppercase text-gray-400 dark:text-gray-500">My Groups</div>
                            <ul className="mr-3 flex flex-nowrap md:mr-0 md:block">
                                <li className="mr-0.5 md:mb-0.5 md:mr-0">
                                    <a className="flex items-center whitespace-nowrap rounded-lg px-2.5 py-2" href="#0">
