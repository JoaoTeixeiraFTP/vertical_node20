...
import UserImage03 from '../../../../../../Documents/mosaicreact/mosaic-react/src/images/user-32-03.jpg';
...
import UserImage08 from '../../../../../../Documents/mosaicreact/mosaic-react/src/images/user-32-08.jpg';
import ProfileImage from '../../../../../../Documents/mosaicreact/mosaic-react/src/images/user-avatar-32.png';
            ...
            <div className="no-scrollbar sticky top-16 h-[calc(100dvh-64px)] shrink-0 overflow-y-auto overflow-x-hidden border-r border-gray-200 bg-white dark:border-gray-700/60 dark:bg-[#151D2C] md:w-[18rem] xl:w-[20rem]">
                ...
                <div>
                            ...
                            <div className="flex w-full items-center justify-between">
                                ...
                                <div className="relative">
                                    <div className="flex grow items-center truncate">
                                        <img className="mr-2 h-8 w-8 rounded-full" src={ProfileImage} width="32" height="32" alt="Group 01" />
                    ...
                    <div className="px-5 py-4">
                        ...
                        {/* Team members */}
                        <div className="mt-4">
                            <div className="mb-3 text-xs font-semibold uppercase text-gray-400 dark:text-gray-500">Team members</div>
                            <ul className="mb-6">
                                <li className="-mx-2">
                                    <button
                                        className="w-full rounded-lg bg-[linear-gradient(135deg,var(--tw-gradient-stops))] from-violet-500/[0.12] to-violet-500/[0.04] p-2 dark:from-violet-500/[0.24]"
                                        onClick={() => setProfileSidebarOpen(false)}
                                    >
                                        <div className="flex items-center">
                                            <div className="relative mr-2">
                                                <img className="h-8 w-8 rounded-full" src={UserImage08} width="32" height="32" alt="User 08" />
                                            </div>
                                            <div className="truncate">
                                ...
                                <li className="-mx-2">
                                    <button className="w-full rounded p-2" onClick={() => setProfileSidebarOpen(false)}>
                                        <div className="flex items-center truncate">
                                            <div className="relative mr-2">
                                                <img className="h-8 w-8 rounded-full" src={UserImage06} width="32" height="32" alt="User 06" />
                                            </div>
                                            <div className="truncate">
                                ...
                                <li className="-mx-2">
                                    <button className="w-full rounded p-2" onClick={() => setProfileSidebarOpen(false)}>
                                        <div className="flex items-center truncate">
                                            <div className="relative mr-2">
                                                <img className="h-8 w-8 rounded-full" src={UserImage03} width="32" height="32" alt="User 03" />
                                            </div>
                                            <div className="truncate">
                                    ...
                                    <button className="w-full rounded p-2" onClick={() => setProfileSidebarOpen(false)}>
                                        <div className="flex items-center truncate">
                                            <div className="relative mr-2">
                                                ...
                                                <div className="absolute right-0 top-0 h-2.5 w-2.5 rounded-full border-2 border-white bg-green-500 dark:border-gray-900"></div>
                                            </div>
                                            <div className="truncate">
