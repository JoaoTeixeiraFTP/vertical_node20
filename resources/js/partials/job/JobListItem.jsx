            ...
            <div className="items-center justify-between space-x-2 space-y-4 md:flex md:space-y-0">
                ...
                <div className="flex items-start space-x-3 md:space-x-4">
                    <div className="mt-1 h-9 w-9 shrink-0">
                        <img className="h-9 w-9 rounded-full" src={props.image} width="36" height="36" alt={props.company} />
                    </div>
                    <div>
                ...
                <div className="flex items-center space-x-4 pl-10 md:pl-0">
                    <div className="whitespace-nowrap text-sm italic text-gray-500 dark:text-gray-400">{props.date}</div>
                    {props.type && (
                        <div
                            className={`inline-flex rounded-full px-2.5 py-1 text-center text-xs font-medium ${
                                props.type === 'Featured' ? 'bg-yellow-500/20 text-yellow-700' : 'bg-green-500/20 text-green-700'
                            }`}
                        >
                            {props.type}
                        </div>
