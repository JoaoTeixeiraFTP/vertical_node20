...
const BadgeColors = {
    COLORS: {
        ...
        invoices: [
            { name: 'Fatura', style: 'text-violet-600 bg-violet-500/20 dark:text-violet-600 dark:bg-violet-500/20 border-none' },
            { name: 'Fatura Ecovalor', style: 'text-sky-700 bg-sky-500/20' },
            ...
            { name: 'Fatura RIC', style: 'text-violet-600 bg-violet-500/20' },
            { name: 'Fatura Serviços', style: 'text-sky-700 bg-sky-500/20' },
            { name: 'Fatura Simplificada', style: 'text-green-700 bg-green-500/20' },
            { name: 'Fatura UE', style: 'text-yellow-700 bg-yellow-500/20' },
            { name: 'Fatura Vila de rei', style: 'text-red-700 bg-red-500/20' },
            { name: 'Fatura_MR', style: 'text-sky-600 bg-sky-500/20 dark:text-sky-600 dark:bg-sky-500/20 border-none' },
            { name: 'Guia de Remessa', style: 'text-gray-500 dark:text-gray-400 bg-gray-400' },
            {
                name: 'Guia de Transporte',
                style: 'text-gray-100 dark:text-gray-600 bg-gray-700 dark:bg-gray-200',
            },
            { name: 'N/C Adiantamento', style: 'text-violet-600 bg-violet-500/20' },
            { name: 'Nota Crédito 78º,nº2', style: 'text-sky-700 bg-sky-500/20' },
            { name: 'Nota Crédito 78º,nº3', style: 'text-green-700 bg-green-500/20' },
            { name: 'Nota Crédito POS', style: 'text-yellow-700 bg-yellow-500/20' },
            { name: 'Nota de Devolução', style: 'text-red-700 bg-red-500/20' },
            { name: 'Nota Débito 78º, nº3', style: 'text-blue-600 bg-blue-500/20' },
