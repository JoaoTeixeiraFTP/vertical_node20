...
export default function AccountDocument({ document }) {
    return (
        <>
            <AuthenticatedLayout header={<span className="text-2xl font-bold text-gray-800 dark:text-gray-100 md:text-3xl">Detalhe Não Regularizado</span>}>
                                    ...
                                    <div className="mx-auto max-w-5xl grow rounded-md bg-[#fffff7] p-6 shadow-lg shadow-gray-300/50 dark:bg-gray-700 dark:shadow-gray-900/50">
                                        <div className="space-y-8 p-6">
                                            ...
                                            <div className="mt-6 flex items-center">
                                                <div className="flex w-1/2 flex-col">
                                                    <div className="text-sm text-gray-600 dark:text-gray-400">Edeb</div>
                                                    <div className="text-lg font-bold text-gray-800 dark:text-gray-100">
                                                        {document.data[0]['edeb'] ?? 'Não disponível'}
                                                    </div>
                                                </div>
