...
export default function NotRegularizedDocument({ document }) {
    return <>
        <AuthenticatedLayout header={<span
            className="text-2xl font-bold text-gray-800 dark:text-gray-100 md:text-3xl">ContaCorrente</span>}>
                                ...
                                <div className="p-6 space-y-8">
                                    ...
                                    <div className="flex items-center mt-4">
                                        <div className="flex flex-col w-1/2">
                                            ...
                                            <div
                                                className="text-lg font-bold text-gray-800 dark:text-gray-100">Recibo
                                                de Cliente
                                            </div>
                                        </div>
                                        <div className="flex flex-col w-1/2 pl-4">
