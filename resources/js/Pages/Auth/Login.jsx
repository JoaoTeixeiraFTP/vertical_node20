            ...
            <main className="bg-white dark:bg-gray-900">
                <div className="relative md:flex">
                    <div className="md:w-1/2">
                        ...
                        <div className="absolute bottom-0 right-0 top-0 m-0 hidden p-0 md:block md:w-1/2" aria-hidden="true">
                            <img
            ...
            <Dialog open={showModal} onOpenChange={setShowModal}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Desculpe, você não tem permissão para acessar esta página. Por favor, entre em contato com o administrador do sistema.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
