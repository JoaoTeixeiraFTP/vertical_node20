...
function DropdownFilter({ align }) {
    ...
    return (
        <div className="relative inline-flex">
            <button
                ref={trigger}
                className="btn rounded-lg border-gray-200 bg-white px-2.5 text-gray-400 hover:border-gray-300 dark:border-gray-700/60 dark:bg-gray-800 dark:text-gray-500 dark:hover:border-gray-600"
                aria-haspopup="true"
