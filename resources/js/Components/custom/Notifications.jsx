...
export default function Notifications({ align }) {
    ...
    return (
        <div className="relative inline-flex">
            <button
                ref={trigger}
                className={`flex h-8 w-8 items-center justify-center rounded-full hover:bg-gray-100 dark:hover:bg-gray-700/50 lg:hover:bg-gray-200 dark:lg:hover:bg-gray-800 ${dropdownOpen && 'bg-gray-200 dark:bg-gray-800'}`}
                aria-haspopup="true"
            ...
            <Transition
                className={`absolute top-full z-10 -mr-48 mt-1 min-w-80 origin-top-right overflow-hidden rounded-lg border border-gray-200 bg-white py-1.5 shadow-lg dark:border-gray-700/60 dark:bg-gray-800 sm:mr-0 ${align === 'right' ? 'right-0' : 'left-0'}`}
                show={dropdownOpen}
