...
function AccordionBasic(props) {
    ...
    return (
        <div className="rounded-lg border border-gray-200 px-5 py-4 dark:border-gray-700/60">
            <button className="group mb-1 flex w-full items-center justify-between" aria-expanded={open} onClick={() => setOpen(!open)}>
                <div className="text-sm font-medium text-gray-800 dark:text-gray-100">{props.title}</div>
                <svg
