            ...
            <Popover>
                <PopoverTrigger asChild>
                    <button
                        id="date"
                        className={cn(
                            'datepicker rounded-lg border-gray-200 dark:border-gray-700/60  flex items-center justify-center form-input dark:bg-gray-800 text-gray-600 hover:text-gray-800 dark:text-gray-300 dark:hover:text-gray-100 font-medium w-[15.5rem]',
                            !date && 'text-muted-foreground',
                        )}
                    >
                        {/* <CalendarIcon /> */}
                        <svg
                            className="ml-1 mr-2 fill-current text-gray-400 dark:text-gray-500"
                            width="16"
                            height="16"
                            viewBox="0 0 16 16"
                        >
